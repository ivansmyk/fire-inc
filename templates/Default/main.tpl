...
<div class="autowr">
 ...
 <div class="content" [logged]style="width:800px;"[/logged]>
  ...
  <div class="footer">
   Vii Engine &copy; 2013 <a class="cursor_pointer" onClick="trsn.box()" onMouseOver="myhtml.title('1', 'Выбор используемого языка на сайте', 'langTitle', 1)" id="langTitle1">{lang}</a>
   <div class="fl_r">
